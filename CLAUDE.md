...
## 한 줄 소개
**TamaBox (타마박스)** — "하루를 키우는 타임박스". 전업투자자 타겟. 타임박스로 하루를 카테고리(운동·언어·주식공부 등)별로 계획하고, 계획을 얼마나 지켰는지 일/주/월로 추적하며, 다마고치 친구(고양이/강아지)를 키우는 귀여운 웹앱.
...
js/character.js         캐릭터 육성(SVG·진화·종·밥주기·도감·테마·여러마리)
js/planner.js           타임박스 그리드(칠하기/인셀 체크박스/키보드/복사·템플릿)
